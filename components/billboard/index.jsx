        ...
        <div className="flex space-x-1 md:space-x-4 mt-1 md:mt-5">
          <div className="bg-white flex items-center justify-center py-1 sm:py-1 md:py-2 px-2 lg:px-3 hover:bg-opacity-50  xl:w-36  rounded-md">
            ...
            <button
              ...
              className="ml-1 md:ml-4 text-[8px] sm:text-sm lg:text-lg xl:text-xl md:font-bold"
            >
              Play
            </button>
          </div>
          <div className="bg-gray-700 flex items-center justify-center py-1 sm:py-1 md:py-2 px-2 lg:px-2 bg-opacity-40 hover:bg-opacity-20 text-white  xl:w-52  rounded-md">
